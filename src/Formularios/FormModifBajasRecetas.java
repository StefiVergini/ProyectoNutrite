...
public class FormModifBajasRecetas extends javax.swing.JInternalFrame {

  Recetario re = new Recetario();
  String dietaElegida;
    public FormModifBajasRecetas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnModificar.setForeground(new java.awt.Color(102, 255, 51));
    ...
    private void BtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModificarActionPerformed
        String titreceta = this.TxtTitReceta.getText().toUpperCase();
       String ingredientes = this.TxtIngredientes.getText().toUpperCase();
       String pasos = this.TxtPasos.getText().toUpperCase();
       String tiporeceta = this.TxtTipoRecip.getText().toUpperCase();
       String puntodeldia = this.TxtMomentodia.getText().toUpperCase();
       String tipodieta = this.CBTipoDieta.getSelectedItem().toString();
       
       Recetario obj1 = new Recetario(titreceta, ingredientes, pasos,tiporeceta, puntodeldia, tipodieta);
      
        try {
            int valor = JOptionPane.showConfirmDialog(this, "¿Está seguro que desea modificar?");
            if (valor == 0) {
                obj1.Modificar(titreceta);
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
       try{
        int var = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea eliminar la receta?", "ALERTA", JOptionPane.YES_NO_OPTION);
               switch (var) {
          
                case 0:
                    re.Bajas(this.TxtTitReceta.getText());
               ...
               this.BtnNuevaBusquedaActionPerformed(evt);
          }catch (Exception e) {
